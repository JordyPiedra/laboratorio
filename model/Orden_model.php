...
public function select_all($EST_ORD="%",$COD_USUCRE='%')
      ...
      return $this->db->select("ID_ORD,COD_ORD,COD_CIR,COD_PER,EST_ORD
								  ...
								  (SELECT CED_PER PRIAPE_PER FROM PERSONA WHERE COD_PER = O.COD_PER) CEDULA",'ORDEN O', "EST_ORD LIKE '$EST_ORD' AND COD_USUCRE LIKE '$COD_USUCRE' ORDER BY FECCRE_ORD DESC", PDO::FETCH_NUM);
